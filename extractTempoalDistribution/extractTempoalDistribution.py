...
Sample commond:
python extractTempoalDistribution.py -i /Users/jibusi/Downloads/winterproject/data/Bendigo2 -o /Users/jibusi/Downloads/winterproject/data
...
############################################################################
def plot_cloudcover(dates, cloudcovers):
...
if outputfile != None and inputfile != None:
    ...
    plot_cloudcover(dates_sorted, cloudcovers_sorted)
